...
namespace ONT_3rdyear_Project.Migrations
{
    ...
    [Migration("20251017140118_updated")]
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.Allergy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AllergyId = 2,
                            Description = "Allergic reaction to peanut proteins",
                            IsDeleted = false,
                            Name = "Peanuts"
                        },
                        new
                        ...
                        {
                            AllergyId = 5,
                            Description = "Allergic reaction to dust mite proteins",
                            IsDeleted = false,
                            Name = "Dust Mites"
                        });
                });
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "55730e64-9632-405e-8128-017caf27a7f0",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGxdojPY1YJpTnHh6XfrD3rCGgij3QqsHV8u+05zL/CokSz6hxLJOZZhtIh5EvfCJQ==",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e7629b27-68a9-41b1-8cfb-a80495b74207",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPOJdzIIJDVlzRz5zXniJxjGaFdIPN2Q5iIRlnzCfsKShg/zAH3gK7APZHA9OdqGFQ==",
                            PhoneNumberConfirmed = false,
                            RoleType = "Nurse",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.HospitalInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2025, 10, 17, 16, 1, 16, 967, DateTimeKind.Local).AddTicks(5576),
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 10, 17, 16, 1, 16, 963, DateTimeKind.Local).AddTicks(5994),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 10, 17, 16, 1, 16, 964, DateTimeKind.Local).AddTicks(9292),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 10, 17, 16, 1, 16, 964, DateTimeKind.Local).AddTicks(9308),
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.Discharge", b =>
                {
                    ...
                    b.HasOne("ONT_3rdyear_Project.Models.Patient", "Patient")
                        .WithOne("Discharges")
                        .HasForeignKey("ONT_3rdyear_Project.Models.Discharge", "PatientID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
