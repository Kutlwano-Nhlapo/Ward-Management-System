...
namespace ONT_3rdyear_Project.Migrations
{
    ...
    [Migration("20250920134750_SyncAdmission")]
    partial class SyncAdmission
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "259e15d8-3736-4b81-9127-e3bae4b46739",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDF3M4viaTei7O2Br0ghroy6DpVUWKe26E1x8Tx0WSHbZQvAkZRXLhH9M+ZWexwRfg==",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "806c3b64-c1e8-4bdb-9068-a4b35bb4b43c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENPnYudOE3+4XqBLgL47BEngyk87in3+VjkxP7b0+xUXqntxqkb7H0tlB5Q17o3wnQ==",
                            PhoneNumberConfirmed = false,
                            RoleType = "Nurse",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.HospitalInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2025, 9, 20, 15, 47, 48, 786, DateTimeKind.Local).AddTicks(1786),
